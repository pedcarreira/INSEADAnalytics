...
**Your Answers here:**
<br>
1. 6 explain have a Cumulative Proportion Explained of 52%
<br>
2. 0.93
<br>
3. Interpretation is that the bonds, currencies, stock indices/aggregators (#3 and 4), and interest rates are the principal determinants of tradable securities. Don't know what to call them.
<br>
4.<br>
pre_crisis_data<br>
```{r echo=FALSE, comment=NA, warning=FALSE, error=FALSE,message=FALSE,results='asis'}
...
```{r echo=FALSE, comment=NA, warning=FALSE, message=FALSE,results='asis',fig.align='center', fig.height=5,fig.width= 8, fig=TRUE}
pnl_plot(crisis_data)
```
<br>
5. There is high correlation with the market both in "bull periods" as well as "bear periods"
<hr>
...
**Your Answers here:**
<br>
1. Invest 1$/day each 20 days, repetitively
<br>
2. Will get different growth trends as one changes the frequency (increasing or reducing from 20). Doesn't seem to get better easily (neither with 10 nor 30)
<br>
<br>
